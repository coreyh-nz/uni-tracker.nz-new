...
class RegisterIntegrationTests(
    ...
    val testUserFactory: TestUserCreator,
) {
    // blue sky
    @Test
    fun `given valid registration details when registering a new year then should create user and password credentials successfully`() {
